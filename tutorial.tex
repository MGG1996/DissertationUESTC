...
%	\uestccover[<学院名称排版风格>]{<论文题目>}{<学科专业>}{<学号>}{<作者姓名>}{<指导教师>}{<教师职称>}{<学院>} % 单学位学士、研究生通用
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \shad{doctor} / \shad{prodoctor} / \shad{intdoctor} / \shad{ipdoctor} / \shad{master} / \shad{promaster} / \shad{intmaster} / \shad{ipmaster} / \shad{bachelor} / \shad{doublebachelor}：该选项设置学位论文类型，分别对应学术学位博士、专业学位博士、International Doctor、International Doctor with Professional Degree、学术学位硕士、专业学位硕士、International Master、International Master with Professional Degree、学士学位以及双学士学位。默认为“\shad{doctor}”。
